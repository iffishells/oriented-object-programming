...
void personal_information(){
	string Name, Middle_Name,surname,Gender,Marital_status,HBA,Nationality,country ,cob,cobb,id, secret_question,religious,hobbies,talent;
	int idnumber;
	...
	cout<<"Entered the Middle Name : "; cin>>Middle_Name;
	...
	cout<<"Enter the Surename : ";cin>>surname;
	...
	cout<<"Enter the Marital_status marrried/single : " ;cin>>Marital_status;
	...
	cout<<"Enter the Date of birth like 9/3/1999 : ";cin>>HBA;
	for(int i ; i<8 ;i++){
		if(HBA[i]=='/'){
			flag=true;
		}
	...
	cout<<"Enter the country of birth : ";cin>>cob;
	if(cob.size()>5 && cob.size()<=8){
		cout<<"correct ";
	}
	else
	{
	...
	cout<<"Enter the country Name : ";cin>>country;
	...
	cout<<"Enter the city of birth : ";cin>>cobb;
	if(cobb.size()>3= && cobb.size()<=7)
	{
		cou<<"correct ";	
	}else
	{
	...
	cout<<"Enter the type of your ID citizennumber/passport:";cin>>id;
	...
	cout<<"Enter the Id number : ";cin>>idnumber;
	
	cout<<"Enter the Identification :/scret question ";cin>>secret_question;
	cout<<"Enter the religious islam/other :";cin>>religious;
cout<<"-----------------------Information on Hobbies---------------"<<endl;
	cout<<"Enter the information Hobbies : Animal/Astrology/Automotive etc :";cin>>hobbies;
	cout<<"Enter the Special Talent Information arts/music/sports :";cin>>talent;
...
void family_information(){
	...
	bool first1=false;
	//bool first2=false;
	/*cout<<"Enter the Mother Name : ";cin>>mothername;
	...
	cout<<"Enter the father Name : ";cin>>fathername;
	...
	cout<<"Enter the number of siblings  one/two/three : ";cin>>siblings;
	
	cout<<"Is your mother alive? yes/NO : ";cin>>ans;
	cout<<"is your father alive? yes/No : " ;cin>>ans1;
	cout<<"Enter the martial status : married/single ";cin>>status;*/
	cout<<"Enter total income of the Month : ";cin>>income;
	...
	cout<<"Do you want to save the information yes/No ";cin>> save ;
}
void contactinfo(){
	...
	cout<<"Enter the Postal code ";cin>>postalcode;
	...
	cout<<"Enter the street Number : " ; cin>>street;
	...
	cout<<"Please state how long you have been living on this address in months or years ." <<endl;
	cout<<"-------------------------------------------------------------------------------"<<endl;
	cout<<"How long you have been residing at this address : Month/years ";cin>>ans2;
